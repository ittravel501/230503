                ...
                <div class="searchfield">
                  <div class="flightdiv2">
                    <ul class="tabs">
                      ...
                      <li class="selected" >
                        <a href="./flight_multi.jsp" class="go1">
                          다구간
                        </a>
                      </li>
                    </ul>
...
<%-- 		        <div class="floating">
		     <% if(mem_nick != null){%>   
          <img src="./flightimgs/이동봉사 신청.png" style="opacity: 100%;" onclick="location.href='#';">
          <%}else{%>
          <img src="./flightimgs/이동봉사 신청.png" style="opacity: 100%;" onclick="alert('로그인이 필요합니다.'); location.href='./login001.jsp';">
          <%} %>
          </div> --%>

...
request.setAttribute("memsex", memsex);
request.setAttribute("memmobile", memmobile);
request.setAttribute("membirth", membirth);
...
request.setAttribute("air_time_minute", airtimeminute);
  ...
  request.getRequestDispatcher("flight_complete_reservation.jsp").forward(request, response);
%>

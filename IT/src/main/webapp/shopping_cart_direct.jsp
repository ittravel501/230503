	...
	<section>
		...
		<table>
		    ...
		    for(int i=0; i<cartinfo.size(); i++) {
		        ...
		        prod_mem_id = cartinfo.get(i).getShop_bas_mem_id();
        ...
        <tr class="s_basket_prod">
                <td><input type="text" name="shop_bas_num" value="<%=shop_bas_prod_num %>" style="width: 50px;" > </td>
                <td><input type="text" name="prod_name" value="<%=prod_name %>" style="width: 50px;" > </td>
                <td><input type="text" name="prod_quantity" value="<%=prod_quantity %>" style="width: 50px;"  > </td>
                <td><input type="text" name="prod_price" value="<%=prod_price %>" style="width: 50px;"  > </td>
                <td><input type="text" name="prod_mem_id" value="<%=prod_mem_id %>" style="width: 50px;"  > </td>

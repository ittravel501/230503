...
<%
  ...
  if(cheapestFlight3 != null) {
    %>
    <div class="salediv1 country3" onclick="location.href='flightAction2.jsp'">
...
<%
  ...
  if(cheapestFlight4 != null) {
    %>
    <div class="salediv1 country4" onclick="location.href='flightAction2.jsp'">
...
<%
  ...
  if(cheapestFlight7 != null) {
    %>
    <div class="salediv1 country7" onclick="location.href='flightAction2.jsp'">
...
<%
  ...
  if(cheapestFlight8 != null) {
    %>
    <div class="salediv1 country8" onclick="location.href='flightAction2.jsp'">
